...
type HistoryListProps = {
	...
	onOpenLink: (upload: UploadRecord) => void;
					...
					<div className="row" key={upload.id}>
						...
						<div className="rowActions">
							<button
								...
								onClick={() => onOpenLink(upload)}
								aria-label={`Open link for ${upload.fileName}`}
								title="Open link"
							>
								<svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
									<path d="M11 4.5h4.5V9" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
									<path d="M15.5 4.5 9 11" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
									<path d="M8 5.5H6A1.5 1.5 0 0 0 4.5 7v7A1.5 1.5 0 0 0 6 15.5h7a1.5 1.5 0 0 0 1.5-1.5v-2" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
								</svg>
							</button>
							<button
								className="iconButton"
